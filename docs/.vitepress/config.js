  ...
  head: [
    [
      "link",
      {
        ...
        sizes: "180x180",
        href: "/assets/img/favicons/mstile-150x150.png",
      },
    ],
    [
      "link",
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Commitment Bias",
            link: "/Mental Models/Commitment Bias.md",
          },
          { text: "Ergodicity", link: "/Mental Models/Ergodicity.md" },
          {
            text: "Genius of the AND",
            link: "/Mental Models/Genius of the AND.md",
          },
          { text: "Leverage", link: "/Mental Models/Leverage.md" },
          { text: "Mental Models", link: "/Mental Models/Mental Models.md" },
          {
            text: "Status Quo Bias",
            link: "/Mental Models/Status Quo Bias.md",
          },
          {
            text: "The Compound Effect",
            link: "/Mental Models/The Compound Effect.md",
          },
        ],
      },
      {
        ...
        items: [
          {
            text: "All I want to Know is Where Im Going to Die So Ill Never Go There",
            link: "/Books/All I want to Know is Where Im Going to Die So Ill Never Go There.md",
          },
          {
            text: "Almanack of Naval Ravikant",
            link: "/Books/Almanack of Naval Ravikant.md",
          },
          ...
          { text: "Cant Hurt Me", link: "/Books/Cant Hurt Me.md" },
          {
            ...
            link: "/Books/Chop Wood, Carry Water.md",
          },
          ...
          { text: "Extreme Ownership", link: "/Books/Extreme Ownership.md" },
          {
            ...
            link: "/Books/Fooled by Randomness.md",
          },
          {
            text: "Gladiators Pirates and Games of Trust",
            link: "/Books/Gladiators Pirates and Games of Trust.md",
          },
          { text: "Great by Choice", link: "/Books/Great by Choice.md" },
          { text: "Grit", link: "/Books/Grit.md" },
          {
            text: "How to Fail at Almost Anything and Still Win Big",
            link: "/Books/How to Fail at Almost Anything and Still Win Big.md",
          },
          ...
          { text: "Skin in The Game", link: "/Books/Skin in The Game.md" },
          {
            ...
            link: "/Books/That WIll Never Work.md",
          },
          {
            text: "The Code of The Extraordinary Mind",
            link: "/Books/The Code of The Extraordinary Mind.md",
          },
          { text: "The Dip", link: "/Books/The Dip.md" },
          {
            text: "The Great Mental Models",
            link: "/Books/The Great Mental Models.md",
          },
          {
            text: "The Happines Advantage",
            link: "/Books/The Happines Advantage.md",
          },
          { text: "The Infinite Game", link: "/Books/The Infinite Game.md" },
          { text: "Think Again", link: "/Books/Think Again.md" },
          {
            text: "Think Like a Rocket Scientist",
            link: "/Books/Think Like a Rocket Scientist.md",
          },
          {
            text: "Understanding the INFJ Personality Type",
            link: "/Books/Understanding the INFJ Personality Type.md",
          },
          { text: "Untitled", link: "/Books/Untitled.md" },
          { text: "War of Art", link: "/Books/War of Art.md" },
          {
            text: "Way of The Peaceful Warrior",
            link: "/Books/Way of The Peaceful Warrior.md",
          },
        ],
      },
    ],
